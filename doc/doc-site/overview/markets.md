...
[The Registry module documentation](https://github.com/econia-labs/econia/blob/main/src/move/econia/build/Econia/docs/Registry.md) contains a more detailed explanation of the problem, omitted here in the interest of brevity.
