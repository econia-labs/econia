...
-  [Function `swap`](#0xc0deb00c_market_swap)
    ...
    -  [Returns](#@Returns_78)
    -  [Aborts](#@Aborts_79)
    -  [Logical branches](#@Logical_branches_80)
...
* <code>test_place_market_order_max_base_buy_user()</code> TODO
