...
export class OO 
{
  ...
  { name: "a", typeTag: new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "CritBit", "CB", [AtomicTypeTag.U64]) },
  { name: "b", typeTag: new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "CritBit", "CB", [AtomicTypeTag.U64]) }];
...
export function add_order$ (
  ...
  o_o = $c.borrow_global_mut<OO>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(addr));
  s_f = $.copy(o_o.f);
...
export function decrement_order_size$ (
  ...
  if ((side == ASK)) {
    temp$1 = $c.borrow_global_mut<OO>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(user_addr)).a;
  }
  else{
    temp$1 = $c.borrow_global_mut<OO>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(user_addr)).b;
  }
  tree = temp$1;
...
export function exists_orders$ (
  ...
  return $c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(a));
}
...
export function get_friend_cap$ (
  ...
  return new FriendCap({  }, new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "FriendCap", []));
}
...
export function init_orders$ (
  ...
  o_o = new OO({ f: $.copy(f), a: CritBit$_.empty$($c, [AtomicTypeTag.U64] as TypeTag[]), b: CritBit$_.empty$($c, [AtomicTypeTag.U64] as TypeTag[]) }, new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]));
  $c.move_to(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), user, o_o);
  return;
}
...
export function remove_order$ (
  ...
  let open_orders;
  open_orders = $c.borrow_global_mut<OO>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(user_addr));
  if ((side == ASK)) {
...
export function scale_factor$ (
  ...
  return $.copy($c.borrow_global<OO>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "Orders", "OO", [$p[0], $p[1], $p[2]]), $.copy(addr)).f);
}

export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::Orders::FriendCap", FriendCap.FriendCapParser);
  repo.addParser("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::Orders::OO", OO.OOParser);
}
