...
export class OC 
{
  ...
  b_a: U64;
  b_c: aptos_framework$_.coin$_.Coin;
  q_a: U64;
  q_c: aptos_framework$_.coin$_.Coin;

  constructor(proto: any, public typeTag: TypeTag) {
    this.b_a = proto['b_a'] as U64;
    this.b_c = proto['b_c'] as aptos_framework$_.coin$_.Coin;
    this.q_a = proto['q_a'] as U64;
    this.q_c = proto['q_c'] as aptos_framework$_.coin$_.Coin;
  }
...
export function buildPayload_cancel_ask (
  ...
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::cancel_ask",
    typeParamStrings,
    [
      $.payloadArg(host),
      $.payloadArg(id),
...
export function buildPayload_cancel_bid (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::cancel_bid",
    typeParamStrings,
    [
      $.payloadArg(host),
      $.payloadArg(id),
...
export function cancel_order$ (
  ...
  if (!$c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(addr))) {
    throw $.abortCode(E_NO_O_C);
  }
  o_c = $c.borrow_global_mut<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(addr));
  if ((side == ASK)) {
    temp$5 = $.copy(addr);
    temp$4 = $.copy(id);
    temp$3 = Caps$_.orders_f_c$($c);
    s_s = Orders$_.cancel_ask$(temp$5, temp$4, temp$3, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    temp$8 = $.copy(host);
    temp$7 = $.copy(id);
    temp$6 = Caps$_.book_f_c$($c);
    Book$_.cancel_ask$(temp$8, temp$7, temp$6, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    temp$10 = $.copy(addr);
    temp$9 = Caps$_.orders_f_c$($c);
    o_c.b_a = $.copy(o_c.b_a).add($.copy(s_s).mul(Orders$_.scale_factor$(temp$10, temp$9, $c, [$p[0], $p[1], $p[2]] as TypeTag[])));
  }
  else{
    temp$13 = $.copy(addr);
    temp$12 = $.copy(id);
    temp$11 = Caps$_.orders_f_c$($c);
    s_s__14 = Orders$_.cancel_bid$(temp$13, temp$12, temp$11, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    temp$17 = $.copy(host);
    temp$16 = $.copy(id);
    temp$15 = Caps$_.book_f_c$($c);
    Book$_.cancel_bid$(temp$17, temp$16, temp$15, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    o_c.q_a = $.copy(o_c.q_a).add($.copy(s_s__14).mul(ID$_.price$($.copy(id), $c)));
  }
  return;
}
...
export function dec_available_collateral$ (
  ...
  order_collateral = $c.borrow_global_mut<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(user));
...
export function deposit$ (
  ...
  let orders_cap;
  orders_cap = Caps$_.orders_f_c$($c);
  deposit_internal$(user, $.copy(b_val), $.copy(q_val), orders_cap, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  update_s_c$(user, orders_cap, $c);
  return;
}
...
export function buildPayload_deposit (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::deposit",
    typeParamStrings,
    [
      $.payloadArg(b_val),
      $.payloadArg(q_val),
...
export function deposit_internal$ (
  ...
  if ($.copy(q_val).gt(u64("0"))) {
    aptos_framework$_.coin$_.merge$(o_c.q_c, aptos_framework$_.coin$_.withdraw$(user, $.copy(q_val), $c, [$p[1]] as TypeTag[]), $c, [$p[1]] as TypeTag[]);
...
export function exists_o_c$ (
  ...
  return $c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(a));
}
...
export function exists_sequence_counter$ (
  ...
  return $c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "SC", []), $.copy(a));
}
...
export function get_available_collateral$ (
  ...
  let order_collateral;
  order_collateral = $c.borrow_global<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(user));
...
export function init_containers$ (
  ...
  if (!!$c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(user_addr))) {
  ...
  temp$1 = aptos_framework$_.coin$_.zero$($c, [$p[0]] as TypeTag[]);
  temp$2 = u64("0");
  temp$3 = aptos_framework$_.coin$_.zero$($c, [$p[1]] as TypeTag[]);
  temp$4 = u64("0");
  o_c = new OC({ b_a: temp$2, b_c: temp$1, q_a: temp$4, q_c: temp$3 }, new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]));
  $c.move_to(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), user, o_c);
  temp$7 = user;
  temp$6 = Registry$_.scale_factor$($c, [$p[2]] as TypeTag[]);
  temp$5 = Caps$_.orders_f_c$($c);
  Orders$_.init_orders$(temp$7, temp$6, temp$5, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  return;
}
...
export function buildPayload_init_containers (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::init_containers",
    typeParamStrings,
    []
  );
...
export function init_o_c$ (
  ...
  if (!!$c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), std$_.signer$_.address_of$(user, $c))) {
    throw $.abortCode(E_O_C_EXISTS);
  }
  if (!Registry$_.is_registered$($c, [$p[0], $p[1], $p[2]] as TypeTag[])) {
    throw $.abortCode(E_NO_MARKET);
...
export function init_user$ (
  ...
  let user_addr;
  user_addr = std$_.signer$_.address_of$(user, $c);
  if (!!$c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "SC", []), $.copy(user_addr))) {
    throw $.abortCode(E_S_C_EXISTS);
  }
  $c.move_to(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "SC", []), user, new SC({ i: aptos_framework$_.account$_.get_sequence_number$($.copy(user_addr), $c) }, new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "SC", [])));
  return;
}
...
export function buildPayload_init_user (
  ...
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::init_user",
    typeParamStrings,
    []
  );
...
export function process_fill$ (
  ...
  orders_cap = Caps$_.orders_f_c$($c);
  if (complete) {
    Orders$_.remove_order$($.copy(target), side, $.copy(id), orders_cap, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  }
  else{
    Orders$_.decrement_order_size$($.copy(target), side, $.copy(id), $.copy(size), orders_cap, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  }
  base_to_route = $.copy(size).mul($.copy(scale_factor));
  quote_to_route = $.copy(size).mul(ID$_.price$($.copy(id), $c));
  if ((side == ASK)) {
  ...
  yields_base = $c.borrow_global_mut<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(base_from));
  base_coins = aptos_framework$_.coin$_.extract$(yields_base.b_c, $.copy(base_to_route), $c, [$p[0]] as TypeTag[]);
  gets_base = $c.borrow_global_mut<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(base_to));
  ...
  gets_quote = $c.borrow_global_mut<OC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(base_from));
...
export function buildPayload_submit_ask (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::submit_ask",
    typeParamStrings,
    [
      $.payloadArg(host),
      $.payloadArg(price),
...
export function buildPayload_submit_bid (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::submit_bid",
    typeParamStrings,
    [
      $.payloadArg(host),
      $.payloadArg(price),
...
export function submit_limit_order$ (
  ...
  if (!Book$_.exists_book$(temp$4, temp$3, $c, [$p[0], $p[1], $p[2]] as TypeTag[])) {
    throw $.abortCode(E_NO_MARKET);
  }
  addr = std$_.signer$_.address_of$(user, $c);
  if (!$c.exists(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "OC", [$p[0], $p[1], $p[2]]), $.copy(addr))) {
  ...
  if ((side == ASK)) {
    ...
    temp$6 = $.copy(size);
    temp$5 = Caps$_.orders_f_c$($c);
    [b_c_subs, ] = Orders$_.add_ask$(temp$9, temp$8, temp$7, temp$6, temp$5, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    ...
    temp$12 = $.copy(price);
    temp$11 = $.copy(size);
    temp$10 = Caps$_.book_f_c$($c);
    c_s = Book$_.add_ask$(temp$15, temp$14, temp$13, temp$12, temp$11, temp$10, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  }
  else{
    id__16 = ID$_.id_b$($.copy(price), $.copy(v_n), $c);
    temp$21 = $.copy(addr);
    temp$20 = $.copy(id__16);
    temp$19 = $.copy(price);
    temp$18 = $.copy(size);
    temp$17 = Caps$_.orders_f_c$($c);
    [, q_c_subs] = Orders$_.add_bid$(temp$21, temp$20, temp$19, temp$18, temp$17, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
    ...
    temp$24 = $.copy(price);
    temp$23 = $.copy(size);
    temp$22 = Caps$_.book_f_c$($c);
    c_s = Book$_.add_bid$(temp$27, temp$26, temp$25, temp$24, temp$23, temp$22, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  }
  if (!!c_s) {
...
export function update_s_c$ (
  ...
  s_c = $c.borrow_global_mut<SC>(new StructTag(new HexString("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9"), "User", "SC", []), $.copy(user_addr));
...
export function withdraw$ (
  ...
  temp$2 = $.copy(q_val);
  temp$1 = Caps$_.orders_f_c$($c);
  withdraw_internal$(temp$4, temp$3, temp$2, temp$1, $c, [$p[0], $p[1], $p[2]] as TypeTag[]);
  temp$6 = user;
  temp$5 = Caps$_.orders_f_c$($c);
  update_s_c$(temp$6, temp$5, $c);
  return;
}
...
export function buildPayload_withdraw (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::withdraw",
    typeParamStrings,
    [
      $.payloadArg(b_val),
      $.payloadArg(q_val),
...
export function withdraw_internal$ (
  ...
  if ($.copy(b_val).gt(u64("0"))) {
    ...
    aptos_framework$_.coin$_.deposit$($.copy(addr), aptos_framework$_.coin$_.extract$(o_c.b_c, $.copy(b_val), $c, [$p[0]] as TypeTag[]), $c, [$p[0]] as TypeTag[]);
  ...
  if ($.copy(q_val).gt(u64("0"))) {
    ...
    aptos_framework$_.coin$_.deposit$($.copy(addr), aptos_framework$_.coin$_.extract$(o_c.q_c, $.copy(q_val), $c, [$p[1]] as TypeTag[]), $c, [$p[1]] as TypeTag[]);
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::OC", OC.OCParser);
  repo.addParser("0x366d989b43410749faf89a28742f43935bd91c65070db5b840bc7777be9201f9::User::SC", SC.SCParser);
}
