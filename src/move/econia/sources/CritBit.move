...
module Econia::CritBit {
    ...
    CB<u8> {
        ...
        *v_r = 16; // Mutate value of node having key 1101
        ...
        let (k, v_r, p_f, i, v) = traverse_pop_p_mut(&mut cb, k, p_f, i, 5);
