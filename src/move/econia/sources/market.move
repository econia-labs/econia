...
module econia::market {
        ...
        OrderBooks
    {
        ...
        // Get place swap order, cancel order event options to return:
        let (place_swap_order_event_option, cancel_order_event_option) =
            ...
            (option::some(place_swap_order_event), cancel_order_event_option)
        };
