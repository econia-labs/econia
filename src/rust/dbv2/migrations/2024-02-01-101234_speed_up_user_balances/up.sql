-- Your SQL goes here
DROP VIEW api.user_balances CASCADE;
...
CREATE INDEX balance_updates_by_handle_handl_market_id_custodian_id_txn_version ON balance_updates_by_handle (handle ASC, market_id ASC, custodian_id ASC, txn_version DESC);
