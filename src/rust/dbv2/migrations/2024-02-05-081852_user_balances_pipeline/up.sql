-- Your SQL goes here
DROP MATERIALIZED VIEW api.user_balances CASCADE;


CREATE TABLE aggregator.user_balances (
    address TEXT NOT NULL,
    custodian_id NUMERIC(20,0) NOT NULL,
    market_id NUMERIC(20,0) NOT NULL,
    handle TEXT NOT NULL,
    base_total NUMERIC(20,0) NOT NULL,
    base_available NUMERIC(20,0) NOT NULL,
    base_ceiling NUMERIC(20,0) NOT NULL,
    quote_total NUMERIC(20,0) NOT NULL,
    quote_available NUMERIC(20,0) NOT NULL,
    quote_ceiling NUMERIC(20,0) NOT NULL,
    PRIMARY KEY(address, custodian_id, market_id)
);


CREATE TABLE aggregator.user_balances_last_indexed_txn (
    txn_version NUMERIC(20) NOT NULL PRIMARY KEY
);


CREATE VIEW api.user_balances AS SELECT * FROM aggregator.user_balances;
