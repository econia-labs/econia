...
export function add_validator_ (
  _account: HexString,
...
export function create_validator_account_ (
...
export function create_validator_operator_account_ (
  _core_resource: HexString,
  _new_account_address: HexString,
  _human_name: U8[],
  $c: AptosDataCache,
...
export function register_validator_config_ (
...
export function remove_validator_ (
  _account: HexString,
  _validator_addr: HexString,
  $c: AptosDataCache,
): void {
...
export function set_validator_config_and_reconfigure_ (
  _validator_operator_account: HexString,
...
export function set_validator_operator_ (
  _account: HexString,
  _operator_name: U8[],
